    ...
    <div class="row">
        <div class="col">
            <div id="wizard-form">
                        ...
                        <div class="panel-body">
                            <form id="first-form">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="report_subject">Report subject <span class="text-danger">*</span></label>
                ...
                <?php elseif (isset($_COOKIE['form']) && $_COOKIE['form'] == 2): ?>
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <strong>To participate in the conference, please fill out the form</strong>
                        </div>
                ...
                <?php elseif (isset($_COOKIE['form']) && $_COOKIE['form'] == 3): ?>
                    <div class="panel panel-info">
                        <div class="panel-heading">
